 ...
 *
 * Anchored on the navy Cardflo publishes as its own theme colour
 ...
 * Nothing else in the codebase hard-codes a colour.
 */
export const cardflo = {
  ...
  charts: {
    series: ['#2450E8', '#00C08B', '#6E86F2', '#03072E', '#E8912B', '#8C93AD'],
    grid: '#E3E8F2',
    axis: '#8C93AD',
  ...
  typography: {
    ...
    /* Injected at runtime. Swap for a self-hosted file if the licence requires. */
    webfontHref:
